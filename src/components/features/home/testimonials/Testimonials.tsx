  ...
  return (
    <section className="border-y border-[#1c1c1e]/10 bg-[#f7f5f0] px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-[1120px]">
        <Reveal>
          <h2 className="max-w-[560px] font-display text-[clamp(1.85rem,3.5vw,2.75rem)] font-normal leading-[1.1] tracking-[-0.04em] text-[#1c1c1e]">
        ...
        <RevealStagger className="mt-16 grid gap-12 md:grid-cols-3 md:gap-10">
          {quotes.map((q) => (
            <blockquote key={q.name}>
              <p className="font-display text-[17px] leading-[1.55] tracking-[-0.02em] text-[#1c1c1e]">
                “{q.body}”
              </p>
              <footer className="mt-6 text-[13px] font-medium text-[#fc5f2b]">
                {q.name} · {q.role}
              </footer>
            </blockquote>
          ))}
