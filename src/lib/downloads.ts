...
const VERSION =
  process.env.NEXT_PUBLIC_DOWNLOAD_VERSION?.trim() || "1.0.0";
...
export const DOWNLOAD_PLATFORMS: DownloadPlatform[] = [
  {
    ...
    version: VERSION,
    sizeLabel: process.env.NEXT_PUBLIC_DOWNLOAD_WINDOWS_SIZE?.trim() || "~113 MB",
    href: envUrl("NEXT_PUBLIC_DOWNLOAD_WINDOWS"),
  ...
  },
  {
    ...
    fileKind: "APK",
    version: VERSION,
    sizeLabel: process.env.NEXT_PUBLIC_DOWNLOAD_ANDROID_SIZE?.trim() || null,
...
export function getPlatform(id: DownloadPlatformId): DownloadPlatform | undefined {
